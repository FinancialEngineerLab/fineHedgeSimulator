...
int main(int argc, const char * argv[])
{
    try
    {
        ...
        Size nSamples = 20;
        Size nTimeSteps = 200;
        Volatility impVol = 0.25;
        Volatility HedgeVol = 0.15;
        ReplicationError RealVolHedge(Option::Call, maturity, strike, underlying, impVol, riskFreeRate, dividendRate,
                                      0);
        RealVolHedge.u_ = riskFreeRate;
